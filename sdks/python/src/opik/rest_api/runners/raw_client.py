...
class RawRunnersClient:
    ...
    def get_job_logs1(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/jobs/{jsonable_encoder(job_id)}/logs",
            method="GET",
            params={
                "offset": offset,
            },
    ...
    def append_job_logs1(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json=convert_and_respect_annotation_metadata(
                object_=request, annotation=typing.Sequence[LogEntry], direction="write"
            ),
            headers={
                "content-type": "application/json",
            },
    ...
    def cancel_job1(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/jobs/{jsonable_encoder(job_id)}/cancel",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def get_job1(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/jobs/{jsonable_encoder(job_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_runner1(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/{jsonable_encoder(runner_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def heartbeat1(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/{jsonable_encoder(runner_id)}/heartbeat",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def list_jobs1(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/{jsonable_encoder(runner_id)}/jobs",
            method="GET",
            params={
                "project": project,
                "page": page,
    ...
    def next_job1(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/{jsonable_encoder(runner_id)}/jobs/next",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def register_agents1(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/{jsonable_encoder(runner_id)}/agents",
            method="PUT",
            json=request,
            headers={
                "content-type": "application/json",
    ...
    def report_job_result1(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/private/runners/jobs/{jsonable_encoder(job_id)}/result",
            method="POST",
            json={
                "status": status,
                "result": result,
